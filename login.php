...
<head>
	...
	<link rel="stylesheet" href="docs/css/uikit.docs.min.css">
...
<body class="uk-height-1-1">
	...
	<div class="uk-vertical-align uk-text-center uk-height-1-1">
		<div class="uk-vertical-align-middle" style="width: 250px;">
			...
			<form class="uk-panel uk-panel-box uk-form" action="logar.php" method="post">
				<div class="uk-form-row">
					<input class="uk-width-1-1 uk-form-large" type="text" placeholder="Login" name="login">
				</div>
				<div class="uk-form-row">
					<input class="uk-width-1-1 uk-form-large" type="text" placeholder="Password" name="password">
				</div>
				<div class="uk-form-row">
					<input class="uk-width-1-1 uk-button uk-button-primary uk-button-large" value="Login" type="submit">
				</div>
